...
<button class="btn btn-secondary btn-sm btn-block" data-toggle="modal" data-target="#create-item" >Tambah Poliklinik</button>
    <br>
...
$(document).ready(function(){
      ...
      $("#table").DataTable({
          "bProcessing": true,
          "sAjaxSource": "<?php echo base_url();?>poliklinik/list",
        });  
...
function edit_category(id){
    $.ajax({
        url : "<?php echo base_url('poliklinik/get')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            var url = "<?php echo base_url();?>poliklinik/update_action/"
            $('[name="id"]').val(data.id);
...
function delete_category(id){
    if(confirm('Yakin mau hapus  ini?')){
        ...
        $.ajax({
            url : "<?php echo base_url()?>poliklinik/delete/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form data-toggle="validator" id="kategori" action="<?php echo base_url();?>poliklinik/create_action" method="POST">
