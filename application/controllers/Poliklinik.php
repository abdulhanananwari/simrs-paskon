...
class Poliklinik extends CI_Controller
{
	...
	public function isLogin(){
		if($this->session->userdata('login') == TRUE){
			$this->template->load('template', 'poliklinik/poliklinik_list');
		}else {
			redirect('login');
		}
    ...
    public function list()
    {
       ...
       $json = array();
       foreach ($this->db->get("poliklinik")->result() as $p) {
    ...
    public function get($id){
        $query = $this->Poliklinik_model->get_by_id($id);
    ...
    public function create_action() 
    {
		...
		'name' => $this->input->post('name',TRUE),
            ...
            $this->Poliklinik_model->insert($data);
    ...
    {
        $row = $this->Poliklinik_model->get_by_id($id);
		...
		'name' => set_value('name', $row->name),
            ...
            $this->template->load('template','poliklinik/category_form', $data);
        } else {
    ...
    public function update_action() 
    {
		...
		'name' => $this->input->post('name',TRUE),
            ...
            $this->Poliklinik_model->update($this->input->post('id', TRUE), $data);
